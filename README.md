...
2. Download ngx_pagespeed:
   ...
   ```bash
   $ cd ~
   $ wget https://github.com/pagespeed/ngx_pagespeed/archive/release-1.6.29.2-beta.zip
   $ unzip release-1.6.29.2-beta.zip # or unzip release-1.6.29.2-beta
   $ cd ngx_pagespeed-release-1.6.29.2-beta/
   $ wget https://dl.google.com/dl/page-speed/psol/1.6.29.2.tar.gz
   $ tar -xzvf 1.6.29.2.tar.gz # expands to psol/
   ```
...
3. Download and build nginx:
   ...
   $ cd nginx-1.4.1/
   $ ./configure --add-module=$HOME/ngx_pagespeed-release-1.6.29.2-beta
   $ make
   $ sudo make install
   ```
