...
mob.button.Dialer.prototype.createButton = function() {
  ...
  a && (this.phoneNumber_ = a, this.dialFn_ = this.dialPhone_);
};
mob.button.Dialer.prototype.clickHandler = function(a) {
  pagespeed.MobUtil.sendBeacon(pagespeed.MobUtil.BeaconEvents.PHONE_BUTTON, goog.bind(this.dialFn_, this));
};
...
mob.button.Dialer.prototype.constructRequestPhoneNumberUrl_ = function() {
  if (this.conversionLabel_ && this.conversionId_ && this.phoneNumber_) {
    ...
    return mob.button.Dialer.CONVERSION_HANDLER_ + window.encodeURIComponent(this.conversionId_) + "/wcm?cl=" + a + "&fb=" + window.encodeURIComponent(this.phoneNumber_);
  }
  return null;
};
...
mob.button.Dialer.prototype.receivePhoneNumber_ = function(a) {
  ...
  c ? (a = {expires:b.expires, formatted_number:b.formatted_number, mobile_number:c, clabel:this.conversionLabel_, fallback:this.phoneNumber_}, a = goog.json.serialize(a), this.debugAlert_("saving phoneNumber in cookie: " + a), this.cookies_.set(mob.button.Dialer.WCM_COOKIE_, window.encodeURIComponent(a), mob.button.Dialer.WCM_COOKIE_LIFETIME_SEC_, "/"), this.phoneNumber_ = c) : this.phoneNumber_ && this.debugAlert_("receivePhoneNumber: " + goog.json.serialize(a));
  this.dialPhone_();
};
