...
pagespeed.MobNav.prototype.redrawHeader_ = function() {
  if (this.headerBar_) {
    var a = -1 == this.headerBarHeight_ ? Math.round(goog.style.getTransformedSize(this.headerBar_).height) : this.headerBarHeight_, b = goog.dom.getViewportSize().width, b = "scale(" + (0 == b ? 1 : (window.innerWidth - goog.style.getScrollbarWidth()) / b).toString() + ")";
