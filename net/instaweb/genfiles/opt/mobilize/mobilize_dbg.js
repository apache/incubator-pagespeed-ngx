...
pagespeed.MobUtil.BeaconEvents = {LOAD_EVENT:"load-event", MAP_BUTTON:"psmob-map-button", MENU_BUTTON_CLOSE:"psmob-menu-button-close", MENU_BUTTON_OPEN:"psmob-menu-button-open", NAV_DONE:"nav-done", PHONE_BUTTON:"psmob-phone-dialer"};
...
pagespeed.MobNav = function() {
  ...
  this.menuButton_ = this.logoSpan_ = null;
...
pagespeed.MobNav.prototype.addMapNavigation_ = function(a) {
  ...
  goog.dom.classlist.add(this.mapButton_, pagespeed.MobUtil.ElementClass.BUTTON);
  ...
  var b = document.createElement(goog.dom.TagName.DIV);
  goog.dom.classlist.add(b, pagespeed.MobUtil.ElementClass.BUTTON_ICON);
  b.id = pagespeed.MobUtil.ElementId.MAP_IMAGE;
  b.style.backgroundImage = "url(" + pagespeed.MobUtil.synthesizeImage(pagespeed.MobNav.MAP_BUTTON, a) + ")";
  this.mapButton_.appendChild(b);
  a = document.createElement(goog.dom.TagName.P);
  goog.dom.classlist.add(a, pagespeed.MobUtil.ElementClass.BUTTON_TEXT);
  this.mapButton_.appendChild(a);
  a.appendChild(document.createTextNode(pagespeed.MobNav.MAP_BUTTON_TEXT_));
};
...
pagespeed.MobNav.prototype.Run = function(a) {
  ...
  !this.navPanel_ && 0 == this.navSections_.length || pagespeed.MobUtil.inFriendlyIframe() || (this.addNavPanel_(a), this.addMenuButtonEvents_(), this.addNavButtonEvents_());
