...
pagespeed.MobNav.prototype.redrawHeader_ = function() {
  if (this.headerBar_) {
    var a = -1 == this.headerBarHeight_ ? Math.round(goog.style.getTransformedSize(this.headerBar_).height) : this.headerBarHeight_, b = "scale(" + window.innerWidth / goog.dom.getViewportSize().width + ")";
    this.headerBar_.style["-webkit-transform"] = b;
    this.headerBar_.style.transform = b;
    b = Math.round(goog.style.getTransformedSize(this.headerBar_).height);
    goog.dom.classlist.remove(this.headerBar_, "hide");
    var c = this.headerBar_.offsetHeight + "px", d = this.dialer_.adjustHeight(c);
    this.mapButton_ && (d += this.headerBar_.offsetHeight);
...
pagespeed.MobNav.prototype.addHeaderBar_ = function(a) {
  ...
  if ("mobile" == psDeviceType || "tablet" == psDeviceType) {
    goog.dom.classlist.add(this.headerBar_, "mobile"), goog.dom.classlist.add(this.spacerDiv_, "mobile"), goog.dom.classlist.add(this.navPanel_, "mobile");
  }
...
pagespeed.MobNav.prototype.addThemeColor_ = function(a) {
  ...
  b = "#" + pagespeed.MobUtil.ElementId.HEADER_BAR + " { background-color: " + b + "; }\n#" + pagespeed.MobUtil.ElementId.NAV_PANEL + " { background-color: " + a + "; }\n#" + pagespeed.MobUtil.ElementId.NAV_PANEL + " li, #" + pagespeed.MobUtil.ElementId.NAV_PANEL + " a, #" + pagespeed.MobUtil.ElementId.NAV_PANEL + " div, #" + pagespeed.MobUtil.ElementId.NAV_PANEL + " p { color: " + b + "; }\n";
  ...
  for (var b = 0, c;c = this.navSections_[b];b++) {
    if (c.parentNode) {
      ...
      for (var f = 0, g = d.length;f < g;f++) {
        ...
        if (h < k) {
          var l = document.createElement(goog.dom.TagName.LI), h = l.appendChild(document.createElement(goog.dom.TagName.DIV)).appendChild(document.createElement(goog.dom.TagName.A));
