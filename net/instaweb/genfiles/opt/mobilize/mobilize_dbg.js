...
mob.button.Dialer.prototype.clickHandler = function(a) {
  this.googleVoicePhoneNumber_ ? pagespeed.MobUtil.sendBeaconEvent(pagespeed.MobUtil.BeaconEvents.PHONE_BUTTON, goog.bind(this.dialPhone_, this)) : (pagespeed.MobUtil.sendBeaconEvent(pagespeed.MobUtil.BeaconEvents.PHONE_BUTTON), this.requestPhoneNumberAndDial_());
};
...
mob.button.Dialer.prototype.receivePhoneNumber_ = function(a) {
  ...
  pagespeed.MobUtil.sendBeaconEvent(pagespeed.MobUtil.BeaconEvents.CALL_CONVERSION_RESPONSE, null, "&t=" + b);
