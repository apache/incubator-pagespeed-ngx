...
pagespeed.MobUtil.BeaconEvents = {CALL_CONVERSION_RESPONSE:"call-conversion-response", LOAD_EVENT:"load-event", MAP_BUTTON:"psmob-map-button", MENU_BUTTON_CLOSE:"psmob-menu-button-close", MENU_BUTTON_OPEN:"psmob-menu-button-open", NAV_DONE:"nav-done", PHONE_BUTTON:"psmob-phone-dialer"};
pagespeed.MobUtil.sendBeacon = function(a, b, c) {
  window.psMobBeaconUrl ? (a = window.psMobBeaconUrl + "?id=psmob&url=" + encodeURIComponent(document.URL) + "&el=" + a, c && (a += c), window.psmob_image_requests || (window.psmob_image_requests = []), c = document.createElement(goog.dom.TagName.IMG), b && (c.addEventListener(goog.events.EventType.LOAD, b), c.addEventListener(goog.events.EventType.ERROR, b)), c.src = a, window.psmob_image_requests.push(c)) : b && b();
};
var mob = {button:{}};
...
mob.button.Map.prototype.clickHandler = function() {
  pagespeed.MobUtil.sendBeacon(pagespeed.MobUtil.BeaconEvents.MAP_BUTTON, goog.bind(this.openMap_, this));
};
...
mob.button.Dialer.WCM_COOKIE_LIFETIME_SEC_ = 7776E3;
...
mob.button.Dialer.prototype.clickHandler = function(a) {
  this.googleVoicePhoneNumber_ ? pagespeed.MobUtil.sendBeacon(pagespeed.MobUtil.BeaconEvents.PHONE_BUTTON, goog.bind(this.dialPhone_, this)) : (pagespeed.MobUtil.sendBeacon(pagespeed.MobUtil.BeaconEvents.PHONE_BUTTON), this.requestPhoneNumberAndDial_());
};
mob.button.Dialer.prototype.requestPhoneNumberAndDial_ = function() {
  debugger;
  var a = this.constructRequestPhoneNumberUrl_();
  a ? (this.debugAlert_("requesting dynamic phone number: " + a), a = new goog.net.Jsonp(a), this.jsonpTime_ = Date.now(), a.send(null, goog.bind(this.receivePhoneNumber_, this), goog.bind(this.receivePhoneNumber_, this))) : this.dialPhone_();
};
...
mob.button.Dialer.prototype.dialPhone_ = function() {
  goog.global.location = "tel:" + (this.googleVoicePhoneNumber_ || this.fallbackPhoneNumber_);
};
mob.button.Dialer.prototype.receivePhoneNumber_ = function(a) {
  debugger;
  var b = Date.now() - this.jsonpTime_;
  pagespeed.MobUtil.sendBeacon(pagespeed.MobUtil.BeaconEvents.CALL_CONVERSION_RESPONSE, null, "&t=" + b);
  if (a = (b = a && a.wcm) && b.mobile_number) {
    b = {expires:b.expires, formatted_number:b.formatted_number, mobile_number:a, clabel:this.conversionLabel_, fallback:this.fallbackPhoneNumber_}, b = goog.json.serialize(b), this.debugAlert_("saving phoneNumber in cookie: " + b), this.cookies_.set(mob.button.Dialer.WCM_COOKIE_, window.encodeURIComponent(b), mob.button.Dialer.WCM_COOKIE_LIFETIME_SEC_, "/"), this.googleVoicePhoneNumber_ = a;
  }
  this.dialPhone_();
};
...
pagespeed.MobTheme.synthesizeLogoSpan = function(a, b, c) {
  ...
  d.appendChild(a);
  return new pagespeed.MobUtil.ThemeData(c, b, d, a);
};
