...
pagespeed.Graphs.prototype.show = function(a) {
  for (var b in pagespeed.Graphs.DisplayDiv) {
...
pagespeed.Graphs.prototype.parseLocation = function() {
  ...
  "" == a ? this.show(pagespeed.Graphs.DisplayDiv.CACHE_APPLIED) : goog.object.contains(pagespeed.Graphs.DisplayDiv, a) && this.show(a);
};
...
pagespeed.Graphs.prototype.createQueryUrl = function() {
  ...
  c = "?json&start_time=" + (new Date(b - pagespeed.Graphs.TIMERANGE_ * a)).getTime();
...
pagespeed.Graphs.prototype.parseAjaxResponse = function() {
  if (this.xhr_.isSuccess()) {
    ...
    this.secondRefreshStarted_ ? (this.parseSnapshotMessages(a), this.psolMessages_.length > pagespeed.Graphs.TIMERANGE_ && this.psolMessages_.shift(), this.drawVisualization()) : (this.parseHistoricalMessages(a), window.setTimeout(goog.bind(this.performRefresh, this), 0));
  } else {
...
pagespeed.Graphs.screenData = function(a, b) {
  var c = !0;
  0 != b.indexOf(a) ? c = !1 : 0 <= b.indexOf("cache_flush_timestamp_ms") ? c = !1 : 0 <= b.indexOf("cache_flush_count") ? c = !1 : 0 <= b.indexOf("cache_time_us") && (c = !1);
  return c;
};
...
pagespeed.Graphs.Start = function() {
  goog.events.listen(window, "load", function() {
    ...
    a.parseLocation();
    for (var b in pagespeed.Graphs.DisplayDiv) {
      goog.events.listen(document.getElementById(pagespeed.Graphs.DisplayMode[b]), "click", goog.bind(a.show, a, pagespeed.Graphs.DisplayDiv[b]));
    }
    ...
    goog.events.listen(a.xhr_, goog.net.EventType.COMPLETE, goog.bind(a.parseAjaxResponse, a));
    setInterval(goog.bind(a.performRefresh, a), 1E3 * pagespeed.Graphs.FREQUENCY_);
    a.performRefresh();
  });
};
