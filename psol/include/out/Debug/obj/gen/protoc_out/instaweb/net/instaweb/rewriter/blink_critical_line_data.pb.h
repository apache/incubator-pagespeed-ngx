...
class BlinkCriticalLineData : public ::google::protobuf::MessageLite {
 public:
  ...
  // optional int64 last_diff_timestamp_ms = 7;
  inline bool has_last_diff_timestamp_ms() const;
  inline void clear_last_diff_timestamp_ms();
  static const int kLastDiffTimestampMsFieldNumber = 7;
  inline ::google::protobuf::int64 last_diff_timestamp_ms() const;
  inline void set_last_diff_timestamp_ms(::google::protobuf::int64 value);
