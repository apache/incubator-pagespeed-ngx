...
class Image : public ::google::protobuf::MessageLite {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_net_2finstaweb_2fspriter_2fpublic_2fimage_5fspriter_2eproto_impl();
  #else
...
class SpriterInput : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const SpriterInput* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class ImagePosition : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const ImagePosition* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class SpriterResult : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const SpriterResult* internal_default_instance() {
    return default_instance_;
  }
  #endif
