...
class CachedResult : public ::google::protobuf::MessageLite {
 public:
  ...
  inline void set_inlined_data(const char* value, size_t size);
  ...
  // optional string low_resolution_inlined_data = 16;
  ...
  inline void set_low_resolution_inlined_data(const char* value, size_t size);
...
inline void CachedResult::set_inlined_data(const char* value, size_t size) {
  set_has_inlined_data();
  if (inlined_data_ == &::google::protobuf::internal::kEmptyString) {
    inlined_data_ = new ::std::string;
  }
...
inline void CachedResult::set_low_resolution_inlined_data(const char* value, size_t size) {
  set_has_low_resolution_inlined_data();
  if (low_resolution_inlined_data_ == &::google::protobuf::internal::kEmptyString) {
    low_resolution_inlined_data_ = new ::std::string;
  }
