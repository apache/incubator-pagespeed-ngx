...
class ProtoResource_Header : public ::google::protobuf::MessageLite {
 public:
  ...
  // above instead.
  static inline const ProtoResource_Header* internal_default_instance() {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_pagespeed_5finput_2eproto_impl();
  #else
...
class ProtoResource : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const ProtoResource* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class ProtoInput : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const ProtoInput* internal_default_instance() {
    return default_instance_;
  }
  #endif
