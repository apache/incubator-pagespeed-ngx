...
class FormatArgument : public ::google::protobuf::MessageLite {
 public:
  ...
  // above instead.
  static inline const FormatArgument* internal_default_instance() {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_pagespeed_5fproto_5fformatter_2eproto_impl();
  #else
...
class FormatString : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const FormatString* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class FormattedUrlResult : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const FormattedUrlResult* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class FormattedUrlBlockResults : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const FormattedUrlBlockResults* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class FormattedRuleResults : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const FormattedRuleResults* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class FormattedResults : public ::google::protobuf::MessageLite {
 public:
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const FormattedResults* internal_default_instance() {
    return default_instance_;
  }
  #endif
