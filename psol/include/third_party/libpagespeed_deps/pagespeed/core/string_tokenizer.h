...
// This file is forked from the Chromium codebase.

#ifndef PAGESPEED_CORE_STRING_TOKENIZER_H_
#define PAGESPEED_CORE_STRING_TOKENIZER_H_
...
#endif  // PAGESPEED_CORE_STRING_TOKENIZER_H_
