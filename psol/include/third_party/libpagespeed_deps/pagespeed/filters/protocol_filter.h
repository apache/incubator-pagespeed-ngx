...
/**
 * A ResourceFilter that only allows protocols from a fixed list.
 */
class ProtocolFilter : public ResourceFilter {
 public:
  ProtocolFilter(std::vector<std::string> *allowed_protocols);
...
#endif  // PAGESPEED_FILTERS_PROTOCOL_FILTER_H_
