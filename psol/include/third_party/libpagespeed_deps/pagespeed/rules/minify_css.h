...
#ifndef PAGESPEED_RULES_MINIFY_CSS_H_
#define PAGESPEED_RULES_MINIFY_CSS_H_
...
class MinifyCss : public MinifyRule {
 public:
  explicit MinifyCss(bool save_optimized_content);
...
#endif  // PAGESPEED_RULES_MINIFY_CSS_H_
