...
#ifndef PAGESPEED_RULES_REMOVE_QUERY_STRINGS_FROM_STATIC_RESOURCES_H_
#define PAGESPEED_RULES_REMOVE_QUERY_STRINGS_FROM_STATIC_RESOURCES_H_
...
/**
 * Checks for requests that are proxy-cacheable but that have query strings in
 * the URL.
 */
class RemoveQueryStringsFromStaticResources : public Rule {
 public:
...
#endif  // PAGESPEED_RULES_REMOVE_QUERY_STRINGS_FROM_STATIC_RESOURCES_H_
