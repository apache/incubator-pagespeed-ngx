...
pagespeed.MobLayout.prototype.dontTouch_ = function(a) {
  ...
  return b == goog.dom.TagName.SCRIPT || b == goog.dom.TagName.STYLE || b == goog.dom.TagName.IFRAME || a.id && this.dontTouchIds_[a.id] || a.classList.contains("psmob-nav-panel") || a.classList.contains("psmob-header-bar") || a.classList.contains("psmob-header-spacer-div") || a.classList.contains("psmob-logo-span");
};
...
pagespeed.MobNav.prototype.addPhoneDialer_ = function(a) {
  ...
  b.src = this.synthesizeImage_(pagespeed.MobNav.CALL_BUTTON_, a);
...
pagespeed.MobNav.prototype.addMapNavigation_ = function(a) {
  ...
  b.src = this.synthesizeImage_(pagespeed.MobNav.MAP_BUTTON_, a);
...
pagespeed.MobNav.prototype.cleanupNavPanel_ = function() {
  for (var a = this.navPanel_.querySelectorAll("*"), b = [], c = 0, d;d = a[c];c++) {
    d.removeAttribute("style"), d.removeAttribute("width"), d.removeAttribute("height"), d.nodeName.toUpperCase() == goog.dom.TagName.A && ("" == d.textContent && d.hasAttribute("title") && d.appendChild(document.createTextNode(d.getAttribute("title"))), "" == d.href && b.push(d));
  }
  for (c = 0;d = b[c];c++) {
...
pagespeed.MobTheme.synthesizeLogoSpan_ = function(a, b, c) {
  ...
  if (a && a.foregroundImage) {
    var e = document.createElement(goog.dom.TagName.IMG);
...
pagespeed.MobTheme.extractTheme = function(a, b) {
  ...
  c.doneCallback = b;
  psMobBackgroundColor && psMobForegroundColor ? (psMobLogoUrl && (c.logo = new pagespeed.MobLogo.LogoRecord, c.logo.foregroundImage = psMobLogoUrl), c.colorComplete_(c.logo, psMobBackgroundColor, psMobForegroundColor)) : (c.logo = (new pagespeed.MobLogo(a)).run(), (new pagespeed.MobColor).run(c.logo, goog.bind(c.colorComplete_, c)));
};
