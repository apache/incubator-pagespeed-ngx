...
pagespeed.MobDialer.prototype.createButton = function() {
  if (this.phoneNumber_) {
    ...
    this.callButton_.onclick = goog.partial(pagespeed.MobUtil.trackClick, "psmob-phone-dialer", a);
  }
...
pagespeed.MobDialer.prototype.getPhoneNumberFromCookie_ = function() {
  ...
  return a && a[2] && (a = goog.json.parse(unescape(a[2])), a.fallback == this.phoneNumber_ && a.clabel == this.conversionLabel_) ? a.mobile_number : null;
};
