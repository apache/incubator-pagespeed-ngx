...
pagespeed.MobColor.prototype.synthesizeCallback_ = function() {
  ...
  if (!(0 < this.numPendingImages_)) {
    ...
    pagespeed.MobUtil.consoleLog("Theme color. Background: " + a + " foreground: " + b);
...
pagespeed.MobColor.prototype.run = function(a, b) {
  ...
  a && a.foregroundImage && !pagespeed.MobUtil.isCrossOrigin(a.foregroundImage) ? (this.numPendingImages_ = 1, this.getImageDataAndSynthesize_("foreground", a.foregroundImage, a.foregroundRect), pagespeed.MobUtil.consoleLog("Found logo. Theme color will be computed from logo.")) : (a && a.foregroundImage ? pagespeed.MobUtil.consoleLog("Found logo but its origin is different that of HTML. Use default color.") : pagespeed.MobUtil.consoleLog("Could not find logo. Use default color."), this.synthesizeCallback_());
};
...
pagespeed.MobLayout.prototype.resizeIfTooWide_ = function(a) {
  ...
  if (!(a.offsetWidth <= this.maxWidth_)) {
    if (b = a.tagName.toUpperCase(), "TABLE" == b) {
      ...
      pagespeed.MobLayout.FLEXIBLE_WIDTH_TAGS_[b] ? (pagespeed.MobUtil.setPropertyImportant(a, "max-width", "100%"), pagespeed.MobUtil.removeProperty(a, "width")) : pagespeed.MobUtil.consoleLog("Punting on resize of " + b + " which wants to be " + a.offsetWidth + " but this.maxWidth_=" + this.maxWidth_);
    }
  }
};
...
pagespeed.MobLogo.LogoRecord = function() {
  ...
  this.backgroundColor = this.backgroundRect = this.backgroundElement = this.foregroundRect = this.foregroundSource = null;
};
    ...
    for (h in pagespeed.MobUtil.ImageSource) {
      if (f = pagespeed.MobUtil.extractImage(a, pagespeed.MobUtil.ImageSource[h])) {
        ...
        if (e == pagespeed.MobUtil.ImageSource.IMG) {
          ...
          k ? (d.width = k.width, d.height = k.height) : a.naturalWidth ? (d.width = a.naturalWidth, d.height = a.naturalHeight) : d.width && d.height || (pagespeed.MobUtil.consoleLog("Image " + a.src + " may be the logo. It has not been loaded so may be missed."), g = !1);
...
pagespeed.MobLogo.prototype.findLogoBackground_ = function(a) {
  ...
  var b = a.foregroundElement, c = this.extractBackgroundColor_(b), d = null;
  for (b.parentNode && (d = pagespeed.MobUtil.castElement(b.parentNode));d && !c;) {
    b = d, c = this.extractBackgroundColor_(b), d = b.parentNode ? pagespeed.MobUtil.castElement(b.parentNode) : null;
  }
  a.backgroundElement = b;
  a.backgroundColor = c || [255, 255, 255];
...
pagespeed.MobNav.prototype.MAP_BUTTON_ = "";
...
pagespeed.MobNav.prototype.mapButtonImage_ = function(a) {
  a = window.atob(this.MAP_BUTTON_);
  return "data:image/gif;base64," + window.btoa(a);
};
...
pagespeed.MobNav.prototype.fixExistingElements_ = function() {
  for (var a = document.getElementsByTagName("*"), b = 0, c;c = a[b];b++) {
    ...
    "fixed" == d.getPropertyValue("position") && "ps-progress-scrim" != c.id && this.fixedPosElements_.push(c);
    999999 <= d.getPropertyValue("z-index") && (pagespeed.MobUtil.consoleLog("Element z-index exceeded 999999, setting to 999998."), c.style.zIndex = 999998);
  }
};
pagespeed.MobNav.prototype.redrawHeader_ = function() {
  ...
  for (var c = 0;c < this.fixedPosElements_.length;c++) {
    var d = this.fixedPosElements_[c];
    if (this.redrawNavCalled_) {
      var e = d.style.top, e = Number(d.style.top.split("px")[0]);
      d.style.top = String(e + (a - b)) + "px";
    } else {
...
pagespeed.MobNav.prototype.redrawNavPanel_ = function() {
  if (this.navPanel_) {
    ...
    var a = .8 * window.innerWidth / pagespeed.MobNav.NAV_PANEL_WIDTH_, b = goog.dom.classlist.contains(this.navPanel_, "open") ? 0 : -pagespeed.MobNav.NAV_PANEL_WIDTH_ * a, b = "scale(" + a + ") translatex(" + b + "px)";
    ...
    this.navPanel_.style.height = (window.innerHeight - b.height) / a + "px";
  }
};
pagespeed.MobNav.prototype.addHeaderBarResizeEvents_ = function() {
  this.redrawHeader_();
  this.redrawNavPanel_();
  window.addEventListener("scroll", goog.bind(function(a) {
    ...
    }, this), 50), goog.dom.classlist.contains(this.navPanel_, "open") && !this.navPanel_.contains(a.target) && (a.stopPropagation(), a.preventDefault()));
  }, this), !1);
  ...
  window.addEventListener("touchmove", goog.bind(function(a) {
...
pagespeed.MobNav.prototype.addHeaderBar_ = function(a) {
  ...
  window.psPhoneNumber && this.addPhoneDialer_(a.menuFrontColor);
  window.psMapLocation && this.addMapNavigation_(a.menuFrontColor);
  this.addHeaderBarResizeEvents_();
};
pagespeed.MobNav.prototype.addPhoneDialer_ = function(a) {
  var b = document.createElement("img");
  b.id = "psmob-phone-image";
  b.src = this.callButtonImage_(a);
  this.callButton_ = document.createElement("a");
  this.callButton_.id = "psmob-phone-dialer";
  a = this.getPhoneNumber_();
  this.callButton_.href = a ? pagespeed.MobNav.createPhoneHref_(a) : "javascript:psRequestDynamicPhoneNumberAndCall()";
...
pagespeed.MobNav.prototype.addMapNavigation_ = function(a) {
  ...
  b.src = this.mapButtonImage_(a);
  this.mapButton_ = document.createElement("a");
  this.mapButton_.id = "psmob-map-button";
  this.mapButton_.href = "https://maps.google.com/maps?q=" + window.psMapLocation;
...
pagespeed.MobNav.prototype.getPhoneNumber_ = function() {
  ...
  var a = document.cookie.match(/(^|;| )gwcm=([^;]+)/);
  return a && a[2] && (a = goog.json.parse(unescape(a[2])), a.fallback == window.psPhoneNumber && a.clabel == window.psPhoneConversionLabel) ? a.mobile_number : null;
};
function psRequestDynamicPhoneNumberAndCall() {
  if (window.psPhoneConversionLabel && window.psPhoneNumber) {
    var a = escape(window.psPhoneConversionLabel), a = "https://www.googleadservices.com/pagead/conversion/" + window.psConversionId + "/wcm?cl=" + a + "&fb=" + escape(window.psPhoneNumber);
    window.psDebugMode && alert("requesting dynamic phone number: " + a);
    (new goog.net.Jsonp(a, "callback")).send(null, pagespeed.MobNav.receivePhoneNumber_, function() {
      window.psDebugMode && alert("error callback called");
      window.psPhoneNumber && psDialPhone(window.psPhoneNumber);
    });
  }
}
goog.exportSymbol("psRequestDynamicPhoneNumberAndCall", psRequestDynamicPhoneNumberAndCall);
pagespeed.MobNav.createPhoneHref_ = function(a) {
  return'javascript:psDialPhone("' + a + '")';
};
function psDialPhone(a) {
  location.href = "tel:" + a;
}
goog.exportSymbol("psDialPhone", psDialPhone);
pagespeed.MobNav.receivePhoneNumber_ = function(a) {
  var b = null;
  if (a && a.wcm) {
    var c = a.wcm;
    c && (b = c.mobile_number);
  }
  b ? (a = {expires:c.expires, formatted_number:c.formatted_number, mobile_number:b, clabel:window.psPhoneConversionLabel, fallback:window.psPhoneNumber}, a = goog.json.serialize(a), window.psDebugMode && alert("saving phone in cookie: " + a), document.cookie = "gwcm=" + escape(a) + ";path=/;max-age=7776000", psDialPhone(b), document.getElementById("psmob-phone-dialer").href = pagespeed.MobNav.createPhoneHref_(b)) : window.psPhoneNumber && (window.psDebugMode && alert("receivePhoneNumber: " + goog.json.serialize(a)), 
...
pagespeed.MobNav.prototype.labelNavDepth_ = function(a, b, c) {
  ...
  c = c || !1;
  for (a = a.firstChild;a;a = a.nextSibling) {
    "UL" == a.tagName ? d = goog.array.join(d, this.labelNavDepth_(a, c ? b + 1 : b, !0)) : ("A" == a.tagName && (a.setAttribute("data-mobilize-nav-level", b), d.push(a)), d = goog.array.join(d, this.labelNavDepth_(a, b, c)));
  }
  return d;
};
...
pagespeed.MobNav.prototype.addNavPanel_ = function() {
  ...
  this.navPanel_.addEventListener("touchmove", goog.bind(function(a) {
...
pagespeed.Mob.prototype.mobilizeSite_ = function() {
  0 == this.pendingImageLoadCount_ ? (pagespeed.MobUtil.consoleLog("mobilizing site"), window.psNavMode && !pagespeed.MobUtil.inFriendlyIframe() ? (++this.pendingCallbacks_, pagespeed.MobTheme.extractTheme(this, this.logoComplete_.bind(this))) : this.maybeRunLayout()) : this.mobilizeAfterImageLoad_ = !0;
};
