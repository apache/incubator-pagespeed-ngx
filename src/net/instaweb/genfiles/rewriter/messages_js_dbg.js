...
var pagespeed = {Messages:function(opt_xhr) {
  ...
  this.reverse_ = this.isRefreshing_ = !1;
  this.filter_ = "";
  this.autoRefresh_ = !1;
...
pagespeed.Messages.prototype.update = function() {
  var logElement = document.getElementById("log"), messages = this.psolMessages_.slice(0);
  if (this.filter_) {
...
pagespeed.Messages.prototype.autoRefresh = function() {
  this.autoRefresh_ && !this.isRefreshing_ && (this.isRefreshing_ = !0, goog.events.listen(this.xhr_, goog.net.EventType.COMPLETE, goog.bind(function(messagesObj) {
    if (this.isSuccess()) {
    ...
    messagesObj.isRefreshing_ = !1;
  }, this.xhr_, this)), this.xhr_.send(document.location.href));
};
pagespeed.Messages.prototype.htmlString = function() {
  var html;
  html = "<table border=1 style='border-collapse: collapse;border-color:silver;'><tr valign='center'>";
...
pagespeed.Messages.Start = function() {
  pagespeedutils.addHandler(window, "load", function() {
    ...
    goog.events.listen(filterElement, "keyup", goog.bind(messagesObj.toggleFilter, messagesObj, filterElement));
