...
TEST_F(ResourceTagScannerTest, FindTags) {
  ...
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[3]);
  ...
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[8]);
  EXPECT_EQ(GoogleString("find_form_action"), resources[9]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[9]);
  ...
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[18]);
  ...
  EXPECT_EQ(ContentType::kOtherShardable, resource_category[20]);
  EXPECT_EQ(GoogleString("blockquote-citation"), resources[21]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[21]);
  EXPECT_EQ(GoogleString("q-citation"), resources[22]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[22]);
  EXPECT_EQ(GoogleString("ins-citiation"), resources[23]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[23]);
  EXPECT_EQ(GoogleString("del-citiation"), resources[24]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[24]);
  EXPECT_EQ(GoogleString("find-area-link"), resources[25]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[25]);
  ...
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[27]);
  EXPECT_EQ(GoogleString("find-iframe-src"), resources[28]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[28]);
  EXPECT_EQ(GoogleString("track-src"), resources[29]);
  EXPECT_EQ(ContentType::kOtherShardable, resource_category[29]);
  EXPECT_EQ(GoogleString("audio-src"), resources[30]);
  EXPECT_EQ(ContentType::kOtherShardable, resource_category[30]);
  EXPECT_EQ(GoogleString("find-video-src"), resources[31]);
  EXPECT_EQ(ContentType::kOtherShardable, resource_category[31]);
  EXPECT_EQ(GoogleString("embed-src"), resources[32]);
  EXPECT_EQ(ContentType::kOtherNonShardable, resource_category[32]);
  EXPECT_EQ(GoogleString("source-src"), resources[33]);
  EXPECT_EQ(ContentType::kOtherShardable, resource_category[33]);
