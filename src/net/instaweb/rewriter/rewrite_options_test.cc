...
TEST_F(RewriteOptionsTest, LookupOptionEnumTest) {
  ...
  EXPECT_EQ(97, RewriteOptions::kEndOfOptions);
...
TEST_F(RewriteOptionsTest, FuriousPrintTest) {
  ...
  EXPECT_EQ("Experiment: 7; ab,ah,ai,cw,cc,ch,jc,gp,jp,jw,mc,pj,db,di,ea,ec,ei,"
            "es,fc,if,fs,hn,hw,ci,ii,il,ji,idp,ig,id,js,tu,ls,ga,cj,cm,co,jo,"
            "pv,rj,rp,rw,rc,rq,ri,rm,cf,rd,jm,cs,cu,is,cp,md,"
