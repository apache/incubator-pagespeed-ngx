  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/pagespeed/kernel/util/circular_buffer_test.cc',
        ...
        '<(DEPTH)/pagespeed/kernel/util/hasher_test.cc',
        '<(DEPTH)/pagespeed/kernel/util/md5_hasher_test.cc',
        '<(DEPTH)/pagespeed/kernel/util/re2_test.cc',
        '<(DEPTH)/pagespeed/kernel/util/ref_counted_ptr_test.cc',
        '<(DEPTH)/pagespeed/kernel/util/shared_string_test.cc',
...
#        'util/split_writer_test.cc',               # not currently needed
    ...
    },
    {
      ...
      'sources': [
        '<(DEPTH)/pagespeed/kernel/html/canonical_attributes.cc',
        '<(DEPTH)/pagespeed/kernel/html/explicit_close_tag.cc',
