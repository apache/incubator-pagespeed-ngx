...
class StatisticsLogger {
 ...
 private:
  ...
  FRIEND_TEST(StatisticsLoggerTest, TestNextDataBlock);
  FRIEND_TEST(StatisticsLoggerTest, TestParseVarData);
  FRIEND_TEST(StatisticsLoggerTest, TestPrintJSONResponse);
  FRIEND_TEST(StatisticsLoggerTest, TestParseDataFromReader);
