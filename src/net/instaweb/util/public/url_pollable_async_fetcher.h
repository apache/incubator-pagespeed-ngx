...
#ifndef NET_INSTAWEB_UTIL_PUBLIC_URL_POLLABLE_ASYNC_FETCHER_H_
#define NET_INSTAWEB_UTIL_PUBLIC_URL_POLLABLE_ASYNC_FETCHER_H_
...
#endif  // NET_INSTAWEB_UTIL_PUBLIC_URL_POLLABLE_ASYNC_FETCHER_H_
