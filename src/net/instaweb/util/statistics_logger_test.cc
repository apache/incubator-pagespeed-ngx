...
#include "net/instaweb/util/statistics_logger.cc"
...
TEST_F(SharedMemStatisticsLoggerTest, TestParseVarData) {
  ...
  logger_.ParseVarDataIntoMap(var_data_piece, var_titles, &parsed_var_data);
  ...
  logger_.ParseVarDataIntoMap(var_data_piece_2, var_titles, &parsed_var_data);
...
TEST_F(SharedMemStatisticsLoggerTest, TestPrintJSONResponse) {
  ...
  logger_.ParseVarDataIntoMap(var_data_2, var_titles, &parsed_var_data);
  ...
  logger_.PrintJSON(list_of_timestamps, parsed_var_data, &writer, &handler_);
