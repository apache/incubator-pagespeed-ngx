...
#ifndef PAGESPEED_KERNEL_UTIL_ABSTRACT_SHARED_MEM_H_
#define PAGESPEED_KERNEL_UTIL_ABSTRACT_SHARED_MEM_H_
...
#endif  // PAGESPEED_KERNEL_UTIL_ABSTRACT_SHARED_MEM_H_
